...
public class MorseCodeViewerM extends JFrame {
    ...
    private void populateTable() {
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT morse_code,text FROM translation_historymorse");

            while (resultSet.next()) {
                String text = resultSet.getString("morse_code");
                String morseCode = resultSet.getString("text");

                // Adding a new row to the table
                DefaultTableModel model = (DefaultTableModel) table.getModel();
                model.addRow(new Object[]{morseCode,text});
            }
